...
A Currency Exchange Dashboard built with Next.js and React that allows users to convert currencies and track real-time exchange rate using Frankfurter API.
